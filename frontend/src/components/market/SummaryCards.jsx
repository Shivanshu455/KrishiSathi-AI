    ...
    const cards = [
        {
            ...
            value: data?.best_market?.price ? `₹${data.best_market.price}` : "₹--",
            change: "+5.2% Today",
            icon: "📈",
        ...
        },
        {
            ...
            value: data?.government_msp?.msp ? `₹${data.government_msp.msp}` : "₹--",
            change: data?.price_difference ? `+₹${data.price_difference} Above MSP` : "-- Above MSP",
            icon: "🏛",
            color: "text-blue-600",
            bg: "bg-blue-50"
        },
